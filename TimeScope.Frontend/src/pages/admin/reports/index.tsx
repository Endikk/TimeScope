      ...
      {statistics && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-blue-900">{statistics.totalUsers}</div>
                  ...
                  <TableBody>
                    {activities.map((activity, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell className="text-right font-semibold">{activity.count}</TableCell>
                    ...
                    {topUsers.map((user, index) => (
                      <TableRow key={user.userId}>
                        ...
                        <TableCell className="text-right">
                          <span className="font-semibold text-primary">{user.actionCount}</span>
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
